...
namespace VolumeControl.Core.Input
{
    ...
    /// </summary>
    public class HotkeyPressedEventArgs : HandledEventArgs
    {
        #region Constructors
        /// <summary>
        /// Creates a new <see cref="HotkeyPressedEventArgs"/> instance without any action settings.
        /// </summary>
        ...
        public HotkeyPressedEventArgs(bool defaultHandledValue) : base(defaultHandledValue)
        {
            Settings = Array.Empty<IActionSettingInstance>();
        }
        /// <summary>
        /// Creates a new <see cref="HotkeyPressedEventArgs"/> instance with the specified <paramref name="actionSettings"/>.
        /// </summary>
        /// <param name="actionSettings">The array of settings to send to the action method.</param>
        public HotkeyPressedEventArgs(IActionSettingInstance[] actionSettings)
        {
        ...
        /// <param name="actionSettings">The array of settings to send to the action method.</param>
        /// <param name="defaultHandledValue">The default value for the <see cref="HandledEventArgs.Handled"/> property.</param>
        public HotkeyPressedEventArgs(IActionSettingInstance[] actionSettings, bool defaultHandledValue) : base(defaultHandledValue)
        {
            Settings = actionSettings;
        }
        ...
        #region GetValue
        /// <summary>
        /// Gets the value of the action setting with the specified <paramref name="name"/> if it is enabled; otherwise gets the setting's default value.
        /// </summary>
        ...
        /// <returns>Value of the setting with the specified <paramref name="name"/> when enabled; otherwise the default value.</returns>
        /// <exception cref="ActionSettingNotFoundException">There is no action setting with the specified <paramref name="name"/>.</exception>
        public object GetValue(string name, StringComparison stringComparison = StringComparison.Ordinal)
        {
            var setting = GetSetting(name, stringComparison);
            return (setting.IsEnabled ? setting.Value : setting.DefaultValue)!;
        }
        /// <summary>
        /// Gets the value of the action setting with the specified <paramref name="name"/> and <paramref name="valueType"/> if it is enabled; otherwise gets the setting's default value.
        /// </summary>
        /// <param name="name">The name of the setting to get.</param>
        /// <param name="valueType">The value type of the setting to get.</param>
        /// <param name="stringComparison">The comparison type to use when performing string comparisons.</param>
        /// <returns>Value of the setting with the specified <paramref name="name"/> &amp; <paramref name="valueType"/> when enabled; otherwise the default value.</returns>
        /// <exception cref="ActionSettingNotFoundException">There is no action setting with the specified <paramref name="name"/> &amp; <paramref name="valueType"/>.</exception>
        public object GetValue(string name, Type valueType, StringComparison stringComparison = StringComparison.Ordinal)
        {
            var setting = GetSetting(name, valueType, stringComparison);
            return (setting.IsEnabled ? setting.Value : setting.DefaultValue)!;
        }
        /// <summary>
        /// Gets the value of the action setting with the specified <paramref name="name"/> and value type if it is enabled; otherwise gets the setting's default value.
        /// </summary>
        /// <typeparam name="T">The value type of the action setting to get.</typeparam>
        /// <param name="name">The name of the action setting to get the value of.</param>
        /// <param name="stringComparison">The type of <see cref="StringComparison"/> to use when comparing strings.</param>
        /// <returns>Value of the setting with the specified <paramref name="name"/> and value type when enabled; otherwise the default value.</returns>
        /// <exception cref="ActionSettingNotFoundException">There is no action setting with the specified <paramref name="name"/> and value type.</exception>
        public T GetValue<T>(string name, StringComparison stringComparison = StringComparison.Ordinal)
        {
            var setting = GetSetting<T>(name, stringComparison);
            return (setting.IsEnabled ? setting.Value : setting.DefaultValue)!;
        }
        #endregion GetValue
        ...
        #region TryGetValue
        /// <summary>
        /// Attempts to get the value of the action setting with the specified <paramref name="name"/> if it is enabled; otherwise gets the setting's default value.
        /// </summary>
        /// <param name="name">The name of the action setting to get the value of.</param>
        /// <param name="stringComparison">The type of <see cref="StringComparison"/> to use when comparing strings.</param>
        ...
        /// <summary>
        /// Attempts to get the value of the action setting with the specified <paramref name="name"/> and <paramref name="valueType"/> if it is enabled; otherwise gets the setting's default value.
        /// </summary>
        /// <param name="name">The name of the setting to get.</param>
        /// <param name="valueType">The value type of the setting to get.</param>
        /// <param name="stringComparison">The comparison type to use when performing string comparisons.</param>
        ...
        /// <summary>
        /// Attempts to get the value of the action setting with the specified <paramref name="name"/> and value type if it is enabled; otherwise gets the setting's default value.
        /// </summary>
        /// <typeparam name="T">The value type of the action setting to get.</typeparam>
        /// <param name="name">The name of the action setting to get the value of.</param>
        /// <param name="stringComparison">The type of <see cref="StringComparison"/> to use when comparing strings.</param>
        ...
        /// <summary>
        /// Gets the value of the action setting with the specified <paramref name="name"/> if it isn't <see langword="null"/> or disabled.
        /// </summary>
        /// <param name="name">The name of the action setting to get the value of.</param>
        /// <param name="stringComparison">The type of <see cref="StringComparison"/> to use when comparing strings.</param>
        ...
        public object GetValueOrDefault(string name, StringComparison stringComparison, object defaultValue = default!)
        {
            if (TryGetSetting(name, stringComparison, out var setting))
                return setting.IsEnabled ? setting.Value ?? defaultValue : defaultValue;
            return defaultValue;
        }
        ...
        /// <summary>
        /// Gets the value of the action setting with the specified <paramref name="name"/> and <paramref name="valueType"/> if it isn't <see langword="null"/> or disabled.
        /// </summary>
        /// <param name="name">The name of the action setting to get the value of.</param>
        /// <param name="valueType">The value type of the setting to get.</param>
        /// <param name="stringComparison">The type of <see cref="StringComparison"/> to use when comparing strings.</param>
        ...
        /// <summary>
        /// Gets the value of the action setting with the specified <paramref name="name"/> and value type if it isn't <see langword="null"/> or disabled.
        /// </summary>
        /// <typeparam name="T">The value type of the action setting to get.</typeparam>
        /// <param name="name">The name of the action setting to get the value of.</param>
        /// <param name="stringComparison">The type of <see cref="StringComparison"/> to use when comparing strings.</param>

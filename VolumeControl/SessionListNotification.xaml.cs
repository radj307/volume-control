...
namespace VolumeControl
{
    ...
    public partial class SessionListNotification : Window
    {
        public SessionListNotification()
        {
            ...
            {
                Source = Settings,
                Path = new PropertyPath(nameof(Config.NotificationTimeoutMs)),
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            if (!_loaded)
            {
                ...
                {
                    this.SetPosAtCorner(Settings.NotificationPositionOriginCorner, pos);
                }
                else
                {
        ...
        private void Window_Closing(object sender, CancelEventArgs e)
        {
            ...
            {
                Settings.NotificationPositionOriginCorner = this.GetCurrentScreenCorner();
                Settings.NotificationPosition = this.GetPosAtCorner(Settings.NotificationPositionOriginCorner);
            }
        }
        #endregion Window
